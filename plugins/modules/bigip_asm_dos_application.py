...
try:
    ...
    from ansible_collections.f5networks.f5_modules.module_utils.icontrol import tmos_version
    from ansible_collections.f5networks.f5_modules.module_utils.icontrol import module_provisioned
